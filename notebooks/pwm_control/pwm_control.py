...
from hvac.controller import PWMController, OutdoorResetController, DataLogger
...
params = [
    ...
    ('bias', 100.0, '%'),                                                               # 17    13
    ('pwm cycle', 10, 'number of time steps'),                                          # 18    14
    ('<b>Outdoor reset line (<code>T_we = c0 + c1 * T_out</code>)</b>', None, None),    # 19
    ('constant term c0', 61.116, '°C'),                                                 # 20    15
    ('slope c1', -1.568, None),                                                         # 21    16
    ('<b>Valve motor</b>', None, None),                                                 # 22
    ('stem travel speed', 0.5, '%/s'),                                                  # 23    17
    ('<b>Control valve</b>', None, None),                                               # 24
    ('valve authority', 0.5, None),                                                     # 25    18
    ('inherent rangeability', 150, None),                                               # 26    19
    ('flow rate at full open position', 2.052 / 1000.0 / 60.0, 'm^3/s'),                # 27    20
    ('<b>Outdoor temperature (T_out)</b>', None, None),                                 # 28
    ('daily average', 5.0, '°C'),                                                       # 29    21
    ('amplitude', 5.0, 'K'),                                                            # 30    22
    ('<b>Measuring sensor</b>', None, None),                                            # 31
    ('delay time', 2, 'number of time steps')                                           # 32    23
]
...
class GUI:
    ...
    def _create_form(self):
        ...
        return ipw.HBox(
            [ipw.VBox(widgets[:19]), ipw.VBox(widgets[19:])],
